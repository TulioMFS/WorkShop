...
namespace SalesWebMvc.Controllers
{
    ...
    {
        private readonly SalesWebMvcContext _context; //Dependência do Entity Framework

        public DepartmentsController(SalesWebMvcContext context) //Construtor para injeção de dependência
        {
            _context = context;
        }
